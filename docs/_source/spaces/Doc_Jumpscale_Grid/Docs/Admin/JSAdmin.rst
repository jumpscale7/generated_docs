...
* you can see on portal on following locations
  ...
  * `http://localhost:81/grid/adminnodes <http://localhost:81/grid/adminnodes>`_
  * `http://localhost:81/grid/adminnode?gridname=york1&name=gm1 <http://localhost:81/grid/adminnode?gridname=york1&name=gm1>`_
  * `http://localhost:81/grid/adminjumpscripts <http://localhost:81/grid/adminjumpscripts>`_
