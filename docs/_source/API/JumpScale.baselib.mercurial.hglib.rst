.. raw:: html
   ...
   <tt class="descname">merge</tt><big>(</big><em>rev=None</em>, <em>force=False</em>, <em>tool=None</em>, <em>cb=&lt;function abort at 0xb9a5f50&gt;</em><big>)</big><a class="reference internal" href="../_modules/JumpScale/baselib/mercurial/hglib/client.html#hgclient.merge"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#JumpScale.baselib.mercurial.hglib.client.hgclient.merge" title="Permalink to this definition">¶</a></dt>
